...
describe('English', () => {
  ...
  it('should report missing translations', () => {
    throws(() => English.translate('missing'), { message: 'English is missing a translation for the "missing" keyword - Please submit a pull request at https://github.com/acuminous/twiki-gherkish-feature-parser/pulls' });
  });
});
