...
describe('Pirate', () => {
  ...
  it('should report missing translations', () => {
    throws(() => Pirate.translate('missing'), { message: 'Pirate is missing a translation for the "missing" keyword - Please submit a pull request at https://github.com/acuminous/twiki-gherkish-feature-parser/pulls' });
  });
});
