...
describe('Norwegian', () => {
  ...
  it('should report missing translations', () => {
    throws(() => Norwegian.translate('missing'), { message: 'Norwegian is missing a translation for the "missing" keyword - Please submit a pull request at https://github.com/acuminous/twiki-gherkish-feature-parser/pulls' });
  });
});
