...
describe('French', () => {
  ...
  it('should report missing translations', () => {
    throws(() => French.translate('missing'), { message: 'French is missing a translation for the "missing" keyword - Please submit a pull request at https://github.com/acuminous/twiki-gherkish-feature-parser/pulls' });
  });
});
