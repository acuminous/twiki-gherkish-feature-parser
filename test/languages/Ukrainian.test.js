...
describe('Ukrainian', () => {
  ...
  it('should report missing translations', () => {
    throws(() => Ukrainian.translate('missing'), { message: 'Ukrainian is missing a translation for the "missing" keyword - Please submit a pull request at https://github.com/acuminous/twiki-gherkish-feature-parser/pulls' });
  });
});
