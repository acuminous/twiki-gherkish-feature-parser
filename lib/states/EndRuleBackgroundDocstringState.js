...
const debug = Debug('twiki:gherkish-feature-parser:states:EndRuleBackgroundDocstringState');
...
export default class EndRuleBackgroundDocstringState extends EndDocstringState {
