...
const debug = Debug('twiki:gherkish-feature-parser:states:DeclareFeatureBackgroundState');
...
export default class DeclareFeatureBackgroundState extends BaseState {
  ...
  onStep(session, event, context) {
    this._machine.toCaptureFeatureBackgroundStepState().dispatch(event, context);
  }
}
