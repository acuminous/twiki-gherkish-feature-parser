...
const debug = Debug('twiki:gherkish-feature-parser:states:CaptureExampleTableHeaderRowState');
...
export default class CaptureExampleTableHeaderRowState extends BaseState {
