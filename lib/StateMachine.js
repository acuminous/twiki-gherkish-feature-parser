...
export default class StateMachine {
  ...
  toConsumeBackgroundStepExplicitDocStringState() {
    this._to(new ConsumeBackgroundStepExplicitDocStringState({ machine: this, featureBuilder: this._featureBuilder }));
  }
  ...
  toConsumeScenarioStepExplicitDocStringState() {
    this._to(new ConsumeScenarioStepExplicitDocStringState({ machine: this, featureBuilder: this._featureBuilder }));
  }
