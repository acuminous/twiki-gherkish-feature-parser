...
import {
  ...
  CreateBackgroundStepDocStringIndentState,
  CreateBackgroundStepDocStringTokenState,
  CreateScenarioState,
  AfterScenarioStepDocStringState,
  AfterScenarioStepState,
  CreateScenarioStepDocStringIndentState,
  CreateScenarioStepDocStringTokenState,
...
export default class StateMachine {
  ...
  toCreateBackgroundStepDocStringIndentState() {
    this._to(new CreateBackgroundStepDocStringIndentState({ machine: this, featureBuilder: this._featureBuilder }));
  }

  toCreateBackgroundStepDocStringTokenState() {
    this._to(new CreateBackgroundStepDocStringTokenState({ machine: this, featureBuilder: this._featureBuilder }));
  }
  ...
  toCreateScenarioStepDocStringIndentState() {
    this._to(new CreateScenarioStepDocStringIndentState({ machine: this, featureBuilder: this._featureBuilder }));
  }

  toCreateScenarioStepDocStringTokenState() {
    this._to(new CreateScenarioStepDocStringTokenState({ machine: this, featureBuilder: this._featureBuilder }));
  }
